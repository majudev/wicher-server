...
bool JSONDatabase::update_type(std::string id, bool update_name, std::string new_name, bool update_comment, std::string new_comment, ErrorID *errorid){
    if(!type_exists(id)){
        *errorid = ID_INVALID;
        return false;
    }
...
bool JSONDatabase::update_wz(int id, bool update_date, std::string new_date, bool update_person, std::string new_person, bool update_comment, std::string new_comment, ErrorID *errorid){
    if(!wz_exists(id)){
        *errorid = ID_INVALID;
        return false;
    }
...
bool JSONDatabase::update_pz(int id, bool update_date, std::string new_date, bool update_person, std::string new_person, bool update_comment, std::string new_comment, ErrorID *errorid){
    if(!pz_exists(id)){
        *errorid = ID_INVALID;
        return false;
    }
...
bool JSONDatabase::update_history(int id, bool update_data, std::string data, ErrorID * errorid){
